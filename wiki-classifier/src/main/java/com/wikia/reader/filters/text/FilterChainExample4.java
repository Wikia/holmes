...
public class FilterChainExample4 {
    private static Logger logger = LoggerFactory.getLogger(FilterChainExample4.class);
    ...
    public static void main(String[] args) throws IOException {
        ...
        saver.setFile(new File(String.valueOf(Paths.get(userHome, "cod4_character.arff"))));
