package com.wikia.reader.input.sweble;
 ...
 * Time: 19:09
 */
public class WikitextVisitor extends AstVisitor {
    private static Logger logger = LoggerFactory.getLogger(WikitextVisitor.class);
    ...
    public WikitextVisitor(SimpleWikiConfiguration config, int wrapCol)
    {
        this.config = config;
